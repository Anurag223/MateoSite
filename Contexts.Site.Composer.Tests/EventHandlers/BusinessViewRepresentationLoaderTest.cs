...
{
    [TestClass]
    public class BusinessViewRepresentationLoaderTest : UnitTestBase
    {
        [TestMethod]
        public void Instantiate_Component_NoExceptionThrown()
        {
            Assert.IsNotNull(TryInstantiateComponent<BusinessViewRepresentationLoader, StartupForSiteComposer, SiteComposerConfiguration>(
        ...
        {
            var sut = new BusinessViewRepresentationLoader(null, null);
            var result = HasBulkRepresentationLoader(sut, "MasterData.BusinessView");
        ...
        [TestMethod]
        public async Task Should_Load_keys()
        {
            var sut = new BusinessViewRepresentationLoader(null, null);
            var result = await sut.Load(Enumerable.Empty<string>());
            result.Should().NotBeNull();
        }
