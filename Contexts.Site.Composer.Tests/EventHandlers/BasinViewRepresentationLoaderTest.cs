...
{
    [TestClass]
    public class BasinViewRepresentationLoaderTest : UnitTestBase
    {
        [TestMethod]
        public void Instantiate_Component_NoExceptionThrown()
        {
            Assert.IsNotNull(TryInstantiateComponent<BasinViewRepresentationLoader, StartupForSiteComposer, SiteComposerConfiguration>(
        ...
        {
            var sut = new BasinViewRepresentationLoader(null, null);
            var result = HasBulkRepresentationLoader(sut, "MasterData.BasinView");
