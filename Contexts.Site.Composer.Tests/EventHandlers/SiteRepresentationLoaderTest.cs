...
{
    [TestClass]
    public class SiteRepresentationLoaderTest : UnitTestBase
    {
        [TestMethod]
        public void Instantiate_Component_NoExceptionThrown()
        {
            Assert.IsNotNull(TryInstantiateComponent<SiteRepresentationLoader, StartupForSiteComposer, SiteComposerConfiguration>(
        ...
        {
            var sut = new SiteRepresentationLoader(null);
            var result = HasBulkRepresentationLoader(sut, "Site");
